...
export default function MonstersSection (): React.ReactNode {
  ...
  return (
    <section id='monsters' className='max-w-6xl mx-auto px-6 py-12'>
      <h2 className='text-2xl font-bold mb-6'>Quelques monstres mignons</h2>
      <div className='grid sm:grid-cols-3 gap-6'>
        {list.map((m) => (
          <div key={m.name} className='p-5 rounded-xl border border-[color:var(--color-black-100)] bg-white'>
            ...
            <div className='text-sm mt-1 text-[color:var(--color-black-600)]'>{m.desc}</div>
