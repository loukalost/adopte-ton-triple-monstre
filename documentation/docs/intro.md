...
Bienvenue dans la documentation technique de **ATTM** ! 🎮

## Qu'est-ce que ATTM ?

ATTM est une application web moderne inspirée des célèbres Tamagotchi, développée dans le cadre d'un projet scolaire à My Digital School. L'application permet aux utilisateurs de créer, nourrir et s'occuper de créatures virtuelles pixelisées.
